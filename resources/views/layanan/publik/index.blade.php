...
@section('content')
    ...
    {{-- ALERT MESSAGES --}}
    @if(session('success'))
        <div class="p-3 mb-4 bg-green-100 text-green-800 rounded-lg shadow-md animate-fadeUp">
            {{ session('success') }}
        </div>
    @endif

    @if(session('error'))
        <div class="p-3 mb-4 bg-red-100 text-red-800 rounded-lg shadow-md animate-fadeUp">
            {{ session('error') }}
        </div>
    @endif
    ...
    <section class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 animate-fadeUp">
        ...
        <div class="flex items-start justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    Isi form singkat untuk memulai permohonan.
                </p>
            </div>
        ...
        <div class="max-w-4xl mx-auto mt-10">
            ...
            <form action="{{ route('pengajuan.store') }}" method="POST"
                  ...
                  class="p-6 rounded-xl shadow bg-white"
                  id="formDinamis">
                ...
                {{-- Button submit muncul setelah layanan dipilih --}}
    ...
    <!-- LIST LAYANAN -->
    <section id="layanan" class="space-y-4 animate-fadeUp mt-10">
        ...
        <div class="flex flex-wrap justify-between items-center mb-4 gap-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                <input id="serviceSearch" type="search"
                       ...
                       class="input input-sm input-bordered w-52 md:w-72"/>
    ...
    <section id="informasi"
             class="bg-white dark:bg-gray-800 rounded-xl border p-4 shadow-sm animate-fadeUp mt-10">
        <h4 class="font-semibold text-gray-700 dark:text-gray-200">Informasi Penting</h4>
        <p class="text-sm text-gray-600 dark:text-gray-300 mt-2">
            Pengumuman dan prosedur layanan dapat dilihat pada detail setiap layanan.
            Pastikan data yang diinput valid untuk mempercepat proses.
        </p>
    </section>
