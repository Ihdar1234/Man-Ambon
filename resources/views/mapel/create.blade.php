...
<div class="max-w-3xl mx-auto p-6">
  <div class="flex items-center justify-between mb-4">
    <h1 class="text-xl font-semibold text-sky-700">Tambah Mata Pelajaran</h1>
  ...
  <div class="bg-white shadow rounded p-6">
    <form action="{{ route('mapel.store') }}" method="POST" class="space-y-4">
      ...
      <div class="flex items-center space-x-2">
        <button type="submit" class="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded">Simpan</button>
